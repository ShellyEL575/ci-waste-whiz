...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-base md:text-xl text-cb-muted max-w-[560px] mb-8 leading-relaxed">
        Answer 13 questions. Get a personalized breakdown of your annual CI waste —
        and the exact savings CloudBees Smart Tests delivers.
      </p>
